  ...
  return (
    <div className='min-h-screen flex flex-col items-center px-6 py-10 w-full'>
        ...
        <div className='md:relative rounded-3xl'>
          <img src="https://nftstorage.link/ipfs/bafybeidb2cru2yjie5xnfjcyk2fhuexdc2eqccjmw7uq4jqetk27hbj6b4" alt='curtains' className='absolute w-full h-full rounded-3xl' />
          <div className='absolute top-0 left-0 w-full h-full rounded-3xl flex items-center justify-center'>
            <img src="https://nftstorage.link/ipfs/bafkreia5b2oyydyhpj2ka7v4gtt66onmj55mr5s6c764l5g744hogslsca" alt='nft' className='w-60 h-60 rounded-3xl' />
          </div>
        </div>
        <div className='pt-10'>
          ...
          <div className='flex my-8'>
            <div className='flex flex-col space-y-2'>
              <div className='flex items-center p-2 pr-6 rounded-full border space-x-4'>
                <div className='w-16 h-16 rounded-full bg-[#9678EF]'></div>
          ...
          <div className='flex items-center justify-center  w-full text-center space-y-2'>
            <div className='w-full'>
              <div className='flex items-center justify-center w-full text-center space-x-2'>
